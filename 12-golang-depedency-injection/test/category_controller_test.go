...
func TestCreateCategorySuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "http://localhost:8132/api/categories", reqBody)
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodPut, "http://localhost:8132/api/categories/"+strconv.Itoa(category.Id), requestBody)
...
func TestGetCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:8132/api/categories/"+strconv.Itoa(category.Id), nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestGetCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:8132/api/categories/404", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestDeleteCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:8132/api/categories/"+strconv.Itoa(category.Id), nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestDeleteCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:8132/api/categories/404", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestListCategorySuccess(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:8132/api/categories", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
